...
class AppManager : NSObject {
    ...
    var languages:[LanguageModel] = [
        ...
        LanguageModel(name: "Hebrew", cultureName: "he"),
        LanguageModel(name: "Hindi", cultureName: "hi"),
        LanguageModel(name: "Hungarian", cultureName: "hu"),
        ...
        LanguageModel(name: "Khmer (Cambodian)", cultureName: "km"),
        ...
        LanguageModel(name: "Portuguese (Brazil)", cultureName: "pt"),
        LanguageModel(name: "Portuguese (Portugal)", cultureName: "pt-PT"),
        LanguageModel(name: "Russian", cultureName: "ru"),
        LanguageModel(name: "Slovak", cultureName: "sk"),
        LanguageModel(name: "Slovenian", cultureName: "sl"),
        LanguageModel(name: "Swedish", cultureName: "sv"),
        LanguageModel(name: "Thai", cultureName: "th"),
        LanguageModel(name: "Turkish", cultureName: "tr"),
